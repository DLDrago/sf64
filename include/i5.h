...
void Titania_TiFekuda_Init(TiFekuda *);
void Titania_TiRasco_Init(TiRasco *);
void Titania_TiRasco_Dying(TiRasco *);
void Titania_TiBomb_Init(TiBomb *);
void Titania_TiDesertCrawler_Init(TiDesertCrawler *);
void Titania_8018E3B0(Actor *);
void Titania_TiDelphor_Init(TiDelphor *);
void Titania_TiDelphorHead_Init(TiDelphorHead *);
void Titania_TiCactus_Init(TiCactus *);
void Titania_TiPillar_Init(TiPillar *);
void Titania_TiGoras_Init(TiGoras *);
void Titania_TiGoras_Dying(TiGoras *);
void Macbeth_InitLevel(void);
void Macbeth_Train_Init(Actor *);
void Macbeth_MaRailroadSwitch_Init(MaRailroadSwitch *);
void Macbeth_MaBoulder_Init(MaBoulder *);
void Macbeth_MaRailwaySignal_Init(MaRailwaySignal *);
void Macbeth_LockBars_Init(Actor *);
void Macbeth_MaBarrier_Init(MaBarrier *);
void Macbeth_MaProximityLight_Init(MaProximityLight *);
void Macbeth_MaMechbeth_Init(MaMechbeth *);
...
void Macbeth_EffectMechbethBeam_Update(EffectMechbethBeam*);
void Macbeth_EffectMechbethBeam_Draw(EffectMechbethBeam*);

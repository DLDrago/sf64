...
typedef struct ChannelModulation {
...
typedef struct DelayedSeqCmd {
    /* 0x0 */ u32 seqData;
    /* 0x4 */ u16 timer;
} DelayedSeqCmd; // size 0x08

typedef struct FrequencyLerp {
    /* 0x00 */ f32 value;
    /* 0x04 */ f32 target;
    /* 0x08 */ u32 timer;
    /* 0x0C */ f32 step;
...
typedef struct PlayerNoiseModulation {

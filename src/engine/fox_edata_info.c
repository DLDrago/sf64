...
ObjectInfo gObjectInfo[] = {
  ...
  /* OBJ_SCENERY_TI_BRIDGE,  */  {(void*)     aTi1BridgeDL, 0, (ObjectFunc)          NULL,        aTiBridgeHitbox,  2000.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_SPRITE_UNK_167  */  {(void*) Sprite167_Draw, 1, (ObjectFunc) Sprite167_Update,       gNoHitbox,   500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SPRITE_UNK_168  */  {(void*) Sprite168_Draw, 1, (ObjectFunc)          NULL,       gNoHitbox,   100.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_JAMES */  {(void*) Andross_James_Draw, 1, (ObjectFunc) Andross_James_Update,       gNoHitbox, 20000.0f,  0, 0, 39, 1,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_MA_BOULDER_CAR */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_MaBoulderCar_Update,        aMaBoulderCarHitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_CONTAINER_BOX */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_MaContainerBox_Update,        aMaContainerBoxHitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_CANNON_CAR */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_MaCannonCar_Update,        aMaCannonCarHitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  /* OBJ_ACTOR_MA_TANK_CAR */  {(void*) Macbeth_Train_Draw, 1, (ObjectFunc) Macbeth_MaTankCar_Update,        aMaTankCarHitbox, 20000.0f,  0, 0, 40, 1,   0.0f,  0 },
  ...
  /* OBJ_ACTOR_AQ_SQUID */  {(void*) Aquas_AqSquid_Draw, 2, (ObjectFunc) Aquas_AqSquid_Update,        aAqSquidRotHitbox,   200.0f,  0, 0, 40, 0,   0.0f,  1 },
  /* OBJ_ACTOR_AQ_SEAWEED */  {(void*) Aquas_AqSeaweed_Draw, 1, (ObjectFunc) Aquas_AqSeaweed_Update,       gCubeHitbox100,   200.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_ACTOR_AQ_BOULDER */  {(void*) Aquas_AqBoulder_Draw, 1, (ObjectFunc) Aquas_AqBoulder_Update,        aAqBoulderHitbox1,   200.0f,  0, 0, 40, 0,   0.0f,  1 },
  ...
  /* OBJ_ACTOR_AQ_OYSTER */  {(void*) Aquas_AqOyster_Draw, 1, (ObjectFunc) Aquas_AqOyster_Update,        aAqOysterHitbox1,  1000.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_ITEM_1UP  */  {(void*)     aItem1UpDL, 0, (ObjectFunc) Item1up_Update,       gCubeHitbox100,   700.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_ITEM_GOLD_RING  */  {(void*) ItemGoldRing_Draw, 1, (ObjectFunc) ItemGoldRing_Update,       gItemSupplyRingHitbox,   700.0f,  0, 0,  0, 0,   0.0f,  0 },
  /* OBJ_ITEM_WING_REPAIR  */  {(void*)     aAwItemLasersDL, 0, (ObjectFunc) ItemWingRepair_Update,       gItemLasersHitbox,   700.0f,  0, 0,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_EFFECT_FIRE_SMOKE_1  */  {(void*) Effect_FireSmoke_Draw, 1, (ObjectFunc) Effect_FireSmoke1_Update,             NULL,  -200.0f,  1, 2,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_FIRE_SMOKE_2  */  {(void*) Effect_FireSmoke_Draw, 1, (ObjectFunc) Effect_FireSmoke2_Update,             NULL,  -200.0f,  1, 2,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_FIRE_SMOKE_3  */  {(void*) Effect_FireSmoke_Draw, 1, (ObjectFunc) Effect_FireSmoke3_Update,             NULL,  -200.0f,  1, 2,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_SMOKE_1  */  {(void*) Effect_Smoke1_Draw, 1, (ObjectFunc) Effect_Smoke1_Update,             NULL,  -200.0f,  1, 2,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_SMOKE_2  */  {(void*) Effect_Smoke2_Draw, 1, (ObjectFunc) Effect_Smoke2_Update,             NULL,  -200.0f,  1, 2,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_EXPLOSION_MARK_1  */  {(void*) Effect_ExplosionMark_Draw, 1, (ObjectFunc) Effect_ExplosionMark_Update,             NULL,  -200.0f, -1, 1,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_LASER_MARK_1  */  {(void*) Effect_LaserMark_Draw, 1, (ObjectFunc) Effect_LaserMark_Update,             NULL,  -200.0f, -1, 1,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_SMALL_ROCK  */  {(void*) Effect_SmallRock_Draw, 1, (ObjectFunc) Effect_SmallRock_Update,             NULL,  -200.0f,  1, 0,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_PINK_EXPLOSION  */  {(void*) Effect_PinkExplosion_Draw, 1, (ObjectFunc) Effect_PinkExplosion_Update,             NULL,   100.0f,  1, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_EFFECT_TI_DUST  */  {(void*) Effect_TiDust_Draw, 1, (ObjectFunc) Effect_TiDust_Update,             NULL,  -100.0f,  1, 2,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_EFFECT_WATER_SPRAY  */  {(void*) Effect_WaterSpray_Draw, 1, (ObjectFunc) Effect_WaterSpray_Update,             NULL,  -200.0f,  0, 1,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_TIMED_SFX  */  {(void*)          NULL, 1, (ObjectFunc) Effect_TimedSfx_Update,             NULL,   500.0f,  0, 1,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_FLAME_PILLAR  */  {(void*) Effect_FlamePillar_Draw, 1, (ObjectFunc) Effect_FlamePillar_Update,             NULL,   100.0f,  0, 1, 40, 0,   0.0f,  0 },
  /* OBJ_EFFECT_375  */  {(void*) Effect_Effect375_Draw, 1, (ObjectFunc) Effect_Effect375_Update,             NULL,  -200.0f,  0, 1,  0, 0,   0.0f,  0 },
  /* OBJ_EFFECT_CO_GRANGA_PLASMA_SHOT  */  {(void*) Effect_EffectGrangaPlasmaShot_Draw, 1, (ObjectFunc) Effect_EffectGrangaPlasmaShot_Update,             NULL,  -200.0f,  1, 0,  0, 0,   0.0f,  0 },
  ...
  /* OBJ_EFFECT_MECHBETH_BEAM  */  {(void*) Macbeth_EffectMechbethBeam_Draw, 1, (ObjectFunc) Macbeth_EffectMechbethBeam_Update,             NULL,   100.0f,  0, 0, 20, 0,   0.0f,  0 },
  ...
  /* OBJ_EFFECT_AND_SUCTION  */  {(void*) Andross_AndSuction_Draw, 1, (ObjectFunc) Andross_AndSuction_Update,             NULL,  2000.0f,  0, 1, 40, 2,   0.0f,  0 },
  /* OBJ_EFFECT_BO_LASER_SHOT  */  {(void*) Bolse_EffectBoLaserShot_Draw, 1, (ObjectFunc) Bolse_EffectBoLaserShot_Update,             NULL,  2000.0f,  0, 1, 20, 0,   0.0f,  0 },
  /* OBJ_EFFECT_398  */  {(void*) Effect_Effect398_Draw, 1, (ObjectFunc) Effect_Effect398_Update,             NULL,   100.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_EFFECT_ORB_RING  */  {(void*) Effect_OrbRing_Draw, 1, (ObjectFunc) Effect_OrbRing_Update,             NULL,   100.0f,  0, 0, 40, 0,   0.0f,  0 },
};
// clang-format on
